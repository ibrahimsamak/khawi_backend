...
export class ContactsComponent implements OnInit {
  ...
  searchByName() {
    ...
    this.contactService.searchUsers(value).subscribe((result) => {
  ...
  rangeChange(event) {
    this.contactService.searchUsersByAge(event).subscribe((result) => {
  ...
  delete(contactId) {
    this.contactService.deleteUser(contactId).then(
      (res) => {
  ...
  getData() {
    this.contactService.getUsers().subscribe((result) => {
      this.items = result;
      this.age_filtered_items = result;
      this.name_filtered_items = result;
    });
