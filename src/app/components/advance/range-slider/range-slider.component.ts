...
export class RangeSliderComponent implements OnInit {
  ...
  customHtmlSliderOptions: Options = {
    ...
    translate: (value: number, label: LabelType): string => {
      switch (label) {
        case LabelType.Low:
          return "<b>Min price:</b> ر.س" + value;
        case LabelType.High:
          return "<b>Max price:</b> ر.س" + value;
        default:
          return "ر.س" + value;
      }
    },
  ...
  onChangeDisabled(): void {
    this.disabledSliderOptions = Object.assign({}, this.disabledSliderOptions, {
  ...
  onChangeReadOnly(): void {
    this.readOnlySliderOptions = Object.assign({}, this.readOnlySliderOptions, {
